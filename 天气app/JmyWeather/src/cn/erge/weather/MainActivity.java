...
public class MainActivity extends BMainActivity {
	...
	// 其他
	private ListView ptr_listView;//下拉刷新对应的listView
	...
	private void initPreToRefresh() {
		...
		ptr_listView = ptrListView.getRefreshableView();
		//设置头View显示
		ptr_listView.addHeaderView(weatherView);
		//设置滑动缓存颜色
		ptr_listView.setCacheColorHint(R.color.transparent);		
	}
	...
	private void setStartWeather(String updateTime, String xinqi,
		...
		ptr_listView.setAdapter(new ArrayAdapter<String>(MainActivity.this,
